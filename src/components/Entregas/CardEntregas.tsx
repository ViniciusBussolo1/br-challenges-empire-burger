...
export function CardEntregas(props: CardEntregaProps) {
  return (
    <div className="h-[5.625rem] mt-[1rem] bg-white rounded-[0.625rem] hover:shadow-cardShadow flex items-center pl-[1.434rem] py-[0.938rem]">
      <div className="bg-[#FAE2CB] p-[0.938rem] rounded-[5rem] h-[3.75rem] w-[3.75rem] flex items-center">
        <img src={props.src} alt="WhatsApp" />
      </div>
      <div className="h-[2.831rem] ml-[1.125rem] mr-[1.502rem] border-[1px] border-traco-funcionamento"></div>
      <div className="w-[23.962rem] h-[2.875rem]">
